...
namespace BSLRMGWEB.Controllers
{
    public class MasterEntryController : Controller
    {
        ...
        public ActionResult AddNewSize()
        {
            return View();
        }
        ...
        public JsonResult Fn_Update_LineDetails_By_LineID(clsLine objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Update_LineDetails_By_LineID", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Worker inserting failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }

        [HttpPost]
        public JsonResult Fn_Insert_New_Worker(clsWorker objReq)
        {
            using (var client = new HttpClient())
            {
                string DocFilePath = "";
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Insert_New_Worker", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
        ...
        [HttpPost]
        public JsonResult Fn_Get_Worker(clsWorker objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Get_Worker", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Fetching Worker failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Update_CustomerDetails_ById(clsCustomer objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Update_CustomerDetails_ById", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Updating Customer details failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Delete_CustomerDetails_ById(clsCustomer objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Delete_CustomerDetails_ById", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Deleting the Customer details failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Delete_DivisionDetails_ById(clsDivision objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Delete_DivisionDetails_ById", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Deleting the Division details failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Delete_SectionDetails_ById(clsSection objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Delete_SectionDetails_ById", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Deleting the Section details failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Delete_LineDetails_ById(clsLine objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Delete_LineDetails_ById", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                ...
                {
                    return Json(new { success = false, message = "Deleting the Line details failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Get_All_SizeName(clsSizeMaster objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
        ...
        public JsonResult Fn_Insert_New_Designation(clsDesignation objReq)
        {
            using (var client = new HttpClient())
            {
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Insert_New_Designation", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Designation insertion failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Get_All_Designation(clsDesignation objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Get_All_Designation", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Designation records not found." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Update_DesignationDetails_By_ID(clsDesignation objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Update_DesignationDetails_By_ID", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Designation updation failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Insert_New_Color(clsColor objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Insert_New_Color", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Color Insertion failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Get_All_Color(clsColor objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Get_All_Color", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Color records are not found." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Update_ColorDetails_By_ID(clsColor objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Update_ColorDetails_By_ID", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Color details are not updated." }, JsonRequestBehavior.AllowGet);
                }
            }
        }

        #region Start For Size 08-APR-2026

        [HttpPost]
        public JsonResult Fn_Add_New_SizeName(clsSizeMaster objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Add_New_SizeName", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Size insertion failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }

        [HttpPost]
        public JsonResult Fn_Update_SizeName(clsSizeMaster objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Update_SizeName", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
        ...
        [HttpPost]
        public JsonResult Fn_Delete_SizeName(clsSizeMaster objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Delete_SizeName", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
        ...
        #endregion End For Size 08-APR-2026

        [HttpPost]
        public JsonResult Fn_Update_GridName(clsSizeMaster objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Update_GridName", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Grid updating failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }

        [HttpPost]
        public JsonResult Fn_Get_All_GridName(clsSizeMaster objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Get_All_GridName", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
        ...
        [HttpPost]
        public JsonResult Fn_Delete_Grid(clsSizeMaster objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Delete_Grid", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Grid deleting failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Fill_AttendanceMonthYear(clsWorker objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Fill_AttendanceMonthYear", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Month Year fill failed", }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        [HttpPost]
        public JsonResult Fn_Fetch_AttendanceDetailsByID(clsWorker objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/MasterEntry/Fn_Fetch_AttendanceDetailsByID", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Worker attendance data are not found", }, JsonRequestBehavior.AllowGet);
                }
            }
        }
