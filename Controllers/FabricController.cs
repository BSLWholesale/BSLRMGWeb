...
namespace BSLRMGWEB.Controllers
{
    public class FabricController : Controller
    {
        ...
        public ActionResult FabricInspection()
        {
            return View();
        }
        ...
        public JsonResult Fn_Update_Fabric_LotNo(clsFabricOrder objReq)
        {
            using (var client = new HttpClient())
            {
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/Fabric/Fn_Update_Fabric_LotNo", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Fabric LotNo Updating failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }

        [HttpPost]
        public JsonResult Fn_Make_New_Batch(clsBatch objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/Fabric/Fn_Make_New_Batch", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Batch creating failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }

        [HttpPost]
        public JsonResult Fn_Get_Batch(clsBatch objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/Fabric/Fn_Get_Batch", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Batch getting failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }

        [HttpPost]
        public JsonResult Fn_Get_BatchList(clsBatch objReq)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(Convert.ToString(ConfigurationManager.AppSettings["BSLRMGAPIURL"]));
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/Fabric/Fn_Get_BatchList", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Batchlist getting failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }
        ...
        public JsonResult Fn_Add_Fabric_Defect_Inspection(Fabric_Defect_Inspection objReq, HttpPostedFileBase FabDefect_Image)
        {
            ...
            if (FabDefect_Image != null && FabDefect_Image.ContentLength > 0)
            {
                ...
                objReq.FabDefect_Image = "/web/DOC/FabricDefectInspection/" + newFileName;
            }
        ...
        [HttpPost]
        public JsonResult Fn_Add_Fabric_Defect_CheckPoint(Fabric_Defect_CheckPoint objReq)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/Fabric/Fn_Add_Fabric_Defect_CheckPoint", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
                ...
                {
                    return Json(new { success = false, message = "Add Fabric Defect checkpoint failed." }, JsonRequestBehavior.AllowGet);
                }
            }
        }

        [HttpPost]
        public JsonResult Fn_Delete_Fabric_Defect_Inspection(Fabric_Defect_Inspection objReq)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpContent content = new StringContent(DATA, UTF8Encoding.UTF8, "application/json");
                HttpResponseMessage responsePost = client.PostAsync("api/Fabric/Fn_Delete_Fabric_Defect_Inspection", content).Result;
                if (responsePost.IsSuccessStatusCode)
                {
                    return Json(new { success = true, message = responsePost.Content.ReadAsStringAsync().Result }, JsonRequestBehavior.AllowGet);
                }
